...
export default function SearchForm() {
  ...
  return (
    <div className="max-w-4xl  mx-auto w-full px-4 sm:px-0 space-y-3">
          ...
          <div className="flex-1 w-full flex flex-col md:flex-row items-center gap-3 md:gap-0">
            ...
            <div className="relative group w-full">
              ...
              {openSuggest && (filteredCommunities.length > 0 || filteredProperties.length > 0) && (
                <div className="absolute left-0 right-0 top-full mt-2 rounded-2xl bg-white shadow-xl border border-white/20 overflow-hidden backdrop-blur-md z-60">
